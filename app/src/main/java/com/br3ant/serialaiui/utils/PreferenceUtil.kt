...
class PreferenceUtil<T>(val name: String, private val default: T, private val spName: String = AppUtils.getAppName()) {

    private val prefs: SharedPreferences by lazy { Utils.getApp().getSharedPreferences(spName, Context.MODE_PRIVATE) }
